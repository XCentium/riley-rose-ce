...
namespace Sitecore.Commerce.Plugin.AdventureWorks
{
    ...
    public class BootstrapAwEnvironmentBlock : PipelineBlock<string, string, CommercePipelineExecutionContext>
    {
        ...
        public override Task<string> Run(string arg, CommercePipelineExecutionContext context)
        {
            ...
            //                                              DebugLevel = "Production",
            //                                              PublicKey =
            //                                                  @"registry:HKEY_LOCAL_MACHINE\SOFTWARE\CommerceServer\Encryption\Keys\CFSolutionStorefrontSite,PublicKey",
            //                                              PrivateKey1 =
            //                                                  @"registry:HKEY_LOCAL_MACHINE\SOFTWARE\CommerceServer\Encryption\Keys\CFSolutionStorefrontSite,PrivateKey",
            //                                              KeyIndex = "1"
            //                                          },
            ...
            //try
            //{
            //    this._persistEntityPipeline.Run(new PersistEntityArgument(environment), context);
            //}
            ...
            //this._persistEntityPipeline.Run(new PersistEntityArgument(environmentAzure), context);
