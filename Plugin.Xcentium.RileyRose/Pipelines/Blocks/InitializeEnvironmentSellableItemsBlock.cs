    ...
    public class InitializeEnvironmentSellableItemsBlock : PipelineBlock<string, string, CommercePipelineExecutionContext>
    {
        ...
        private async Task BootstrapAppliances(CommercePipelineExecutionContext context)
        {
            var item = new SellableItem
            {
                Components = new List<Component>
                {
                    new CatalogComponent { Name = "RileyRose_Mater" },
                        ...
                        ChildComponents = new List<Component>
                            {
                                ...
                                {
                                    Id = "56042591",
                                    Name = "RileyRose Viva 4-Door 34.0 Cubic Foot Refrigerator w/ Ice Maker and Wifi (Stainless)",
                                    Policies = new List<Policy>
                                    {
                                ...
                                {
                                    Id = "56042592",
                                    Name = "RileyRose Viva 4-Door 34.0 Cubic Foot Refrigerator w/ Ice Maker and Wifi (Black)",
                                    Policies = new List<Policy>
                                    {
                                        new ListPricingPolicy(new List<Money> { new Money("USD", 3029.99M), new Money("CAD", 3030.99M) })
                                    },
                                ...
                                {
                                    Id = "56042593",
                                    Name = "RileyRose Viva 4-Door 34.0 Cubic Foot Refrigerator w/ Ice Maker and Wifi (White)",
                                    Policies = new List<Policy>
                                    {
                                        new ListPricingPolicy(new List<Money> { new Money("USD", 3029.99M), new Money("CAD", 3030.99M) })
                                    },
                ...
                Name = "RileyRose Viva 4-Door 34.0 Cubic Foot Refrigerator with Ice Maker and Wifi"
            };
                        ...
                        ChildComponents = new List<Component>
                            {
                                ...
                                {
                                    Id = "56042122",
                                    Name = "XSound 7” CD DVD, In-Dash Receiver, 3-Way Speakers, and RileyRosePro Installation",
                                    Policies = new List<Policy>
                                    {
