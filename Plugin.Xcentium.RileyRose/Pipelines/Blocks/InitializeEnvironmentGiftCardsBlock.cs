...
namespace Plugin.Xcentium.RileyRose
{
    ...
    /// <summary>
    /// Defines a RileyRose GiftCard SellableItem during the environment initialization.
    /// </summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(RileyRoseConstants.Pipelines.Blocks.InitializeEnvironmentGiftCardsBlock)]
    public class InitializeEnvironmentGiftCardsBlock : PipelineBlock<string, string, CommercePipelineExecutionContext>
    {
        ...
        {
            const string ArtifactSet = "Environment.RileyRose.GiftCards-1.0";
