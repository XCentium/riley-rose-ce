    ...
    public static class HabitatConstants
    {
        ...
        public static class Pipelines
        {
            ...
            public static class Blocks
            {
                ...
                /// </summary>
                public const string InitializeEnvironmentGiftCardsBlock = "Habitat.block.InitializeEnvironmentGiftCards";

                /// <summary>
                /// The add cart line gift card block nME.
                /// </summary>
                public const string AddCartLineGiftCardBlock = "Habitat.block.AddCartLineGiftCard";

                /// <summary>
                /// The initialize environment ensure catalog block name.
                /// </summary>
                public const string InitializeEnvironmentEnsureCatalogBlock = "Habitat.block.InitializeEnvironmentEnsureCatalog";
            }
        }
    }
}
